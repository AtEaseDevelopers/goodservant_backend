...
class AgentDataTable extends DataTable
{
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addAction(['title' => trans('agents.action'), 'printable' => false])
            ->parameters([
    ...
    protected function getColumns()
    {
        return [
            ...
            'employeeid'=> new \Yajra\DataTables\Html\Column(['title' => trans('agents.employee_id'),
            'data' => 'employeeid',
            'name' => 'agents.employeeid']),
           ...
           /* 'bankdetails1'=> new \Yajra\DataTables\Html\Column(['title' => 'Bank Details 1',
            ...
            'status'=> new \Yajra\DataTables\Html\Column(['title' =>  trans('agents.status'),
            'data' => 'status',
            'name' => 'agents.status']),

            'remark'=> new \Yajra\DataTables\Html\Column(['title' =>  trans('agents.remark'),
            'data' => 'remark',
            'name' => 'agents.remark'])
        ];
    }
