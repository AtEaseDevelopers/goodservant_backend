...
class ClaimDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'claims.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Claim $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Claim $model)
    {
        return $model->newQuery()->with('driver:id,name')->with('lorry:id,lorryno')->with('deliveryorder:id,dono')->select('claims.*');
    }
        ...
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ...
                    ['extend' => 'excelHtml5','text'=>'<i class="fa fa-file-excel-o"></i> Excel','exportOptions'=> ['columns'=>':visible:not(:last-child)'], 'className' => 'btn btn-default btn-sm no-corner','title'=>null,'filename'=>'Claim'.date('dmYHis')],
                    ['extend' => 'pdfHtml5', 'orientation' => 'landscape', 'pageSize' => 'LEGAL','text'=>'<i class="fa fa-file-pdf-o"></i> PDF','exportOptions'=> ['columns'=>':visible:not(:last-child)'], 'className' => 'btn btn-default btn-sm no-corner','title'=>null,'filename'=>'Claim'.date('dmYHis')],
    ...
    protected function getColumns()
    {
        return [
            ...
            'data' => 'lorry.lorryno',
            'name' => 'lorry.lorryno']),
            'deliveryorder_id'=> new \Yajra\DataTables\Html\Column(['title' => 'DO',
            'data' => 'deliveryorder.dono',
