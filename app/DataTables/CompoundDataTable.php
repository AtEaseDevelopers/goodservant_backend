...
class CompoundDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->with('driver:id,name')->with('lorry:id,lorryno')->select('compounds.*');
    }
        ...
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ...
                    ['extend' => 'excelHtml5','text'=>'<i class="fa fa-file-excel-o"></i> Excel','exportOptions'=> ['columns'=>':visible:not(:last-child)'], 'className' => 'btn btn-default btn-sm no-corner','title'=>null,'filename'=>'Compound'.date('dmYHis')],
                    ['extend' => 'pdfHtml5', 'orientation' => 'landscape', 'pageSize' => 'LEGAL','text'=>'<i class="fa fa-file-pdf-o"></i> PDF','exportOptions'=> ['columns'=>':visible:not(:last-child)'], 'className' => 'btn btn-default btn-sm no-corner','title'=>null,'filename'=>'Compound'.date('dmYHis')],
