...
class SpecialPriceDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\SpecialPrice $model
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addAction(['title' => trans('special_prices.action'), 'printable' => false])
            ->parameters([
    ...
    {
        return 'special_prices_datatable_' . time();
    }
}
