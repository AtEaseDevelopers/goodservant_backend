...
class PriceDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'prices.datatables_actions');
    }
    ...
    {
        return $model->newQuery()->with('item:id,code')->with('vendor:id,code')->with('source:id,code')->with('destinate:id,code')->select('prices.*');
    }
        ...
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ...
                    ['extend' => 'excelHtml5','text'=>'<i class="fa fa-file-excel-o"></i> Excel','exportOptions'=> ['columns'=>':visible:not(:last-child)'], 'className' => 'btn btn-default btn-sm no-corner','title'=>null,'filename'=>'ItemPrice'.date('dmYHis')],
                    ['extend' => 'pdfHtml5', 'orientation' => 'landscape', 'pageSize' => 'LEGAL','text'=>'<i class="fa fa-file-pdf-o"></i> PDF','exportOptions'=> ['columns'=>':visible:not(:last-child)'], 'className' => 'btn btn-default btn-sm no-corner','title'=>null,'filename'=>'ItemPrice'.date('dmYHis')],
    ...
    protected function getColumns()
    {
        return [
            ...
            'data' => 'destinate.code',
            'name' => 'destinate.code']),
            'minrange'=> new \Yajra\DataTables\Html\Column(['title' => 'Min (TON)',
            'data' => 'minrange',
            'name' => 'minrange']),
            'maxrange'=> new \Yajra\DataTables\Html\Column(['title' => 'Max (TON)',
            'data' => 'maxrange',
            'name' => 'maxrange']),
            'billingrate'=> new \Yajra\DataTables\Html\Column(['title' => 'Billing Rate',
            'data' => 'billingrate',
            'name' => 'prices.billingrate']),
            'commissionrate'=> new \Yajra\DataTables\Html\Column(['title' => 'Commission Rate',
            'data' => 'commissionrate',
            'name' => 'prices.commissionrate']),
