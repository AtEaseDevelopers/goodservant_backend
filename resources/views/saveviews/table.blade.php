    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="infoModelLabel">{{ __('invoices.select_a_date_range') }}</h5>
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-sm-12">
                <label for="datefrommodel">{{ __('invoices.date') }}:</label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="dateRange();">{{ __('invoices.search') }}</button>
          <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('invoices.close') }}</button>
        </div>
      </div>
    </div>
</div>