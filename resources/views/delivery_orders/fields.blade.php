...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('dono', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255,'autofocus', 'placeholder' => 'SYSTEM GENERATED IF BLANK']) !!}
</div>
...
<!-- Supervisor Id Field -->
<div class="form-group col-sm-6">
    {!! Form::label('supervisor_id',  __('delivery_orders.supervisor'))  !!}
