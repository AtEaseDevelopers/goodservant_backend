...
@section('content')
    <ol class="breadcrumb">
      <li class="breadcrumb-item">
         <a href="{!! route('deliveryOrders.index') !!}">Delivery Orders</a>
      </li>
                                ...
                                {!! Form::open(['route' => ['deliveryOrders.adddetail',Crypt::encrypt($id)]]) !!}
                                    ...
                                    @push('scripts')
                                        <script>
                                            ...
                                            function getprice(){
                                                var deliveryorder_id = {{ $id }};
                                                var product_id = $('#product_id').val();
                                                if(deliveryorder_id != '' && product_id != ''){
                                                    ShowLoad();
                                                    var url = '{{ config("app.url") }}/deliveryOrders/getprice/'+deliveryorder_id+'/'+product_id;
